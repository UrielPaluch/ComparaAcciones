...
checkBoxDerivadaDiscretaTicker1 = Checkbutton(miFrame, text = "", variable = varDerivadaDiscretaTicker1).grid(row = 2, column = 2, pady = 5, padx = 5)

varDerivadaDiscretaTicker2 = IntVar()
checkBoxDerivadaDiscretaTicker2 = Checkbutton(miFrame, text = "", variable = varDerivadaDiscretaTicker2).grid(row = 3, column = 2, pady = 5, padx = 5)
